// Inside StandingsPage() return block
<SimulatorClient initialTeams={report.teams}>
  {({ standings, sim, reset, isAnimating, shuffleLogos, NBA_ODDS }) => (
    <>
      {/* SIMULATION CONTROLS */}
      <div className="flex justify-center gap-4 mb-12">
        <button onClick={sim} disabled={isAnimating} className="bg-[#2f3e4e] text-white px-10 py-4 rounded font-black uppercase tracking-widest shadow-xl hover:bg-black transition-all disabled:opacity-50">
